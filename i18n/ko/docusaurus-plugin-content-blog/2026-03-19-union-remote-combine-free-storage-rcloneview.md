...
> 구글에서 15GB, 원드라이브에서 5GB, 드롭박스에서 2GB, 메가에서 20GB. 개별적으로는 작지만, 유니온 리모트로 결합하면 하나의 커다란 무료 스토리지 풀이 됩니다.
...
결합하면: 여러 서비스에 걸쳐 60GB 이상의 무료 스토리지를 확보할 수 있습니다.
...
빠른 스토리지(구글 드라이브)와 대용량 스토리지(메가)를 하나의 풀로 결합합니다.
