...
- 진행: **619/619 포스트 번역 완료 — 블로그 완역** (× 8로케일 = 4,952파일), 전체 빌드 통과. 남은 번역: docs (howto 47 + tutorials 19 + release-notes 14 = 80편)
- 커밋 이력:
...
| (HEAD) | 배치 7(최종): 99포스트 (792파일) — 아티팩트 자동교정 규칙 추가(</invoke>), YAML 3건, 원문 버그 6종 수리 |
